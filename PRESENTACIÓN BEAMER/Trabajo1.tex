...
%\begin{frame}
%\frametitle{Resultados}puesto que en la ultima década se ha convertido en un enfoque común para el desarrollo de diseños estructurales resistentes a los terremotos en zonas especificas
%\end{frame}

\begin{frame}
\frametitle{Conclusiones}
\begin{itemize}
%\item Se puede concluir que estas distribuciones tienen un uso muy importante en problemas sociales y económicos de gran tamaño. 
